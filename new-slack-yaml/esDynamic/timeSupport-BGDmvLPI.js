...
async function Ye() {
  return (await import("./geometryEngineJSON-CGLyUZax.js").then((e) => e.g)).geodesicBuffer;
}
function Ze(e) {
...
function He() {
  return import("./geometryEngineJSON-CGLyUZax.js").then((e) => e.g);
}
...
//# sourceMappingURL=timeSupport-BGDmvLPI.js.map
