import { hX as T } from "./main-BmGptCZr.js";
...
function y() {
  return new Promise((t) => import("./lyr3DWorker-1l2e9ILK.js").then((r) => r.l).then(({ default: r }) => {
...
//# sourceMappingURL=Lyr3DWorker-DRvnyQjX.js.map
