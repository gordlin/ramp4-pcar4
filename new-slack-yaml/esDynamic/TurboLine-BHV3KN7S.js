import { af as le, hX as ue } from "./main-BmGptCZr.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-C48GDCjy.js").then((i) => i.l) : await import("./libtess-B98ERq8p.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-BHV3KN7S.js.map
