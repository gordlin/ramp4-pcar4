import { hX as K, bh as D } from "./main-BmGptCZr.js";
import { y as X } from "./DoubleArray-C3dv9n7a.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-uaWfdAp7.js";
import { n as Z, s as ee } from "./vec3-CCkjktER.js";
import "./sphere--8uN0KC9.js";
import "./I3SUtil-ZA0zdIDi.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-DOwGIjrN.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-BmGptCZr.js").then((d) => d.qK), import("./main-BmGptCZr.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-hglnTdrV.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-01YPxkuk.js.map
