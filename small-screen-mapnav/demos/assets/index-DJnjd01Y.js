    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        withDirectives((openBlock(), createElementBlock("div", {
          ...
          _cache[1] || (_cache[1] = createBaseVNode("span", { class: "py-1" }, null, -1)),
          windowHeight.value <= 460 ? (openBlock(), createBlock(_component_mapnav_button, {
            key: 0,
            class: "mapnav-section bg-white-75 hover:bg-white self-center",
            onClickFunction: () => {
              sepNavVisible.value = !sepNavVisible.value;
            },
            tooltip: sepNavVisible.value ? _ctx.$t("mapnav.closeMenu") : _ctx.$t("mapnav.openMenu")
          }, {
            default: withCtx(() => [
              (openBlock(), createElementBlock("svg", {
                ...
                class: normalizeClass(["fill-current w-6 mx-auto transition-all transform", { "rotate-180": sepNavVisible.value }])
              }, _cache[0] || (_cache[0] = [
                createBaseVNode("path", { d: "m270.08 5.89 43.04 43.04c7.85 7.86 7.83 20.72 0 28.54L134.77 255.82l178.35 178.35c7.85 7.86 7.8 20.73 0 28.54l-43.04 43.04c-7.83 7.82-20.71 7.82-28.54 0L49.29 313.49l-.37-.36-43.04-43.04c-7.82-7.83-7.86-20.68 0-28.54l43.04-43.04.37-.36L241.54 5.89c7.85-7.85 20.68-7.85 28.54 0z" }, null, -1)
              ]), 2))
            ]),
            _: 1
          }, 8, ["onClickFunction", "tooltip"])) : createCommentVNode("", true),
          windowHeight.value > 460 ? (openBlock(), createElementBlock("div", _hoisted_3, [
        ...
        windowHeight.value <= 460 && sepNavVisible.value ? withDirectives((openBlock(), createElementBlock("div", {
          key: 0,
          class: normalizeClass(["absolute right-56 bottom-36 sm:bottom-48 mapnav-section flex flex-col flex-wrap gap-x-1 items-start", { "h-[165px]": windowHeight.value <= 400, "h-[99px]": windowHeight.value <= 340 }]),
          content: unref(t)("panels.controls.items")
        }, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(visible.value, (button, index) => {
            return openBlock(), createElementBlock(Fragment, {
              ...
              (openBlock(), createBlock(resolveDynamicComponent(button.id + "-nav-button"), { class: "mapnav-section bg-white-75 hover:bg-white" })),
              index !== visible.value.length - 1 ? (openBlock(), createBlock(DividerNav, {
                key: 0,
                class: "mapnav-divider"
              })) : createCommentVNode("", true)
...
const MapnavV = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7fd17c29"]]);
