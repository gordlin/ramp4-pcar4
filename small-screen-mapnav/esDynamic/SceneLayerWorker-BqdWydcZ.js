import { hX as K, bh as D } from "./main-awKEFivJ.js";
import { y as X } from "./DoubleArray-CIJpnD_h.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-Cw6IDT5X.js";
import { n as Z, s as ee } from "./vec3-BjSXOPrM.js";
import "./sphere-79tBx_P6.js";
import "./I3SUtil-DiE3j5ES.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-D7XVdZ_C.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-awKEFivJ.js").then((d) => d.qK), import("./main-awKEFivJ.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-BT4kJ1XE.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-BqdWydcZ.js.map
