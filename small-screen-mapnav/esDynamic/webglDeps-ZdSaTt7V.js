import{r as c}from"./Program-DApHDGD-.js";import{c as m,E as p,s as u}from"./Program-DApHDGD-.js";import{fa as l}from"./main-D8a2_wp1.js";import{t as $}from"./NestedMap-CJlcHrNH.js";import{a as d,o as h,e as b}from"./ProgramTemplate-BlPDhbrc.js";import{c as x}from"./Texture-qX2W_hus.js";class _{constructor(e){this._rctx=e,this._store=new $}dispose(){this._store.forEach(e=>e.forEach(t=>t.dispose())),this._store.clear()}acquire(e,t,r,a){const s=this._store.get(e,t);if(s!=null)return s.ref(),s;const o=new c(this._rctx,e,t,r,a);return o.ref(),this._store.set(e,t,o),o}get test(){}}function g(i){const{options:e,value:t}=i;return typeof e[t]=="number"}function y(i){let e="";for(const t in i){const r=i[t];if(typeof r=="boolean")r&&(e+=`#define ${t}
