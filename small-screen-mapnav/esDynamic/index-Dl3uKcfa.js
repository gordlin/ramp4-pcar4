import { iO as A, iP as y, bx as M, fB as $, ha as O, fK as D, hb as B } from "./main-awKEFivJ.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-DZfho4cw.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-cr_pPyL6.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-DErfxLG9.js")).default, n = (await import("./index-BSCGUdS3.js")).default, a = (await import("./index-DOtAYo_s.js")).default, w = (await import("./index-B4ERACrt.js")).default, p = (await import("./index-BoTk5i19.js")).default, r = (await import("./index-rVszqm4o.js")).default, b = (await import("./index-CN4gn7K4.js")).default;
...
//# sourceMappingURL=index-Dl3uKcfa.js.map
