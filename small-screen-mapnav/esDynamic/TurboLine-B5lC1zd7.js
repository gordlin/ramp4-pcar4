import { af as le, hX as ue } from "./main-awKEFivJ.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-eoQy8BFC.js").then((i) => i.l) : await import("./libtess-BNJ5Ye0a.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-B5lC1zd7.js.map
