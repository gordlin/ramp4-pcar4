...
class Ps {
  ...
  async projectExtent(e, t) {
    ...
    const a = new re("warpy", [o], t.sr, !0), l = await this.projectGeometry(e, a), n = l.toArray().pop() || [], c = n.map((y) => y[0]), u = n.map((y) => y[1]), p = Math.min.apply(null, c), d = Math.max.apply(null, c), g = Math.min.apply(null, u), h = Math.max.apply(null, u);
...
const Hs = ["data-cy"], ji = /* @__PURE__ */ k({
  ...
  setup(r) {
    ...
    return (n, c) => {
      ...
      return v(), w("div", {
        class: te(["shadow-tm bg-white h-full xs:mr-0 sm:mr-12 last:mr-0 pointer-events-auto min-w-0 shrink-0", r.panel.expanded ? "flex-grow max-w-full" : ""]),
    ...
    return Je(() => {
      ...
      return v(), w("div", {
        ...
        P(m("div", {
          ...
          class: te(["rv-dropdown shadow-md border border-gray:200 py-8 bg-white rounded z-10", { "text-center": r.centered }]),
          ref_key: "dropdown",
          ref: o
        }, [
          Me(p.$slots, "default", {
...
const ir = ["content"], sr = { class: "flex items-center text-left" }, rr = { class: "select-text cursor-text" }, or = ["content"], ar = {
  ...
  setup(r) {
    ...
    return (n, c) => {
      const u = M("tippy");
      return P((v(), w("li", {
        class: te(["flex-col default-focus-style p-4", r.notification.messageList ? "cursor-pointer" : ""]),
        ...
        m("div", sr, [
          ...
          r.notification.messageList ? (v(), w("div", {
            key: 0,
            class: te(["dropdown-icon p-4 pointer-events-none", { "transform -rotate-180": s.value }])
          }, c[2] || (c[2] = [
            m("svg", {
              xmlns: "http://www.w3.org/2000/svg",
              height: "24",
      ...
      return v(), W(ei, {
        ...
        default: ie((c) => [
          m("div", fr, [
            ...
            oe(Wi, { class: "overflow-y-auto h-230" })
          ])
        ]),
        _: 1
      }, 8, ["tooltip"]);
  ...
  setup(r) {
    ...
    return (A, b) => {
      ...
      return v(), w("div", Or, [
        ...
        oe(br, { class: "sm:block display-none" }),
        d() ? (v(), w("span", kr, [
          m("a", {
          ...
          n.value?.disabled ? U("", !0) : (v(), W($, {
            ...
            default: ie(() => [
              (v(!0), w(We, null, ht(u.value, (F, ce) => (v(), w("a", {
                key: `${F}-${ce}`,
                class: te(["flex-auto items-center text-sm sm:text-base cursor-pointer", { "font-bold": F === S(s).$i18n.locale.value }]),
                href: "javascript:;",
                onClick: (Xe) => g(F)
              }, [
  ...
  setup(r) {
    ...
    return (c, u) => (v(), w("div", Qr, [
      m("div", Xr, [
        ...
        oe(Kr),
        oe(Js, { class: "panel-stack sm:flex absolute inset-0 overflow-hidden sm:p-12 z-10 sm:pl-80 xs:pl-40 sm:pb-48 xs:pb-28 xs:pr-0 sm:pr-40" }),
    ...
    return Je(() => {
      ...
      return P((v(), w("div", {
        ...
        r.header ? (v(), w("header", So, [
          oe(T, {
            class: te(r.panel.teleport ? "display-none" : "block sm:display-none"),
          ...
          m("div", {
            class: te(r.panel.teleport ? "flex" : "display-none sm:flex")
          }, [
  ...
  setup(r) {
    ...
    return (t, i) => {
      ...
      return v(), w("div", Co, [
        P((v(), w("button", {
          type: "button",
          class: te(["text-gray-500 hover:text-black focus:text-black p-8", { "text-gray-700": r.active }]),
  ...
  setup(r) {
    ...
    return (t, i) => {
      ...
      return v(), w("div", Wo, [
        P((v(), w("button", {
          type: "button",
          class: te(["text-gray-500 hover:text-black focus:text-black p-6", { "text-gray-700": r.active }]),
  ...
  setup(r) {
    return (e, t) => {
      ...
      return v(), w("div", la, [
        P((v(), w("button", {
          type: "button",
          class: te(["w-full h-full default-focus-style", [r.showOutline ? "focus:outline focus:outline-2 focus:outline-blue-400" : "focus:outline-none"]]),
...
const Mn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-C1tvKm7N.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-llfH4Sjy.js"), "../fixtures/basemap/index.ts": () => import("./index-BhjZ7ksI.js"), "../fixtures/crosshairs/index.ts": () => import("./index-CD_Zz-Nf.js"), "../fixtures/details/index.ts": () => import("./index-DQZpGLOM.js"), "../fixtures/export-footnote/index.ts": () => import("./index-kv9-qQ1C.js"), "../fixtures/export-legend/index.ts": () => import("./index-Nh0MOAZx.js"), "../fixtures/export-map/index.ts": () => import("./index-CxkvZFSG.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-D9skcxmy.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-DJBrrhKA.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-zhqWveyP.js"), "../fixtures/export-title/index.ts": () => import("./index-Cea7Gf8k.js"), "../fixtures/export/index.ts": () => import("./index-DvubiMmu.js"), "../fixtures/extentguard/index.ts": () => import("./index-P4q0A09a.js"), "../fixtures/gazebo/index.ts": () => import("./index-ItqpJem4.js"), "../fixtures/geosearch/index.ts": () => import("./index-C38VyVf-.js"), "../fixtures/grid/index.ts": () => import("./index-BX2u8yjp.js"), "../fixtures/help/index.ts": () => import("./index-CRmBAAtj.js"), "../fixtures/hilight/index.ts": () => import("./index-Dr54Niod.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-BBkZOKZR.js"), "../fixtures/legend/index.ts": () => import("./index-CFyWA_AA.js"), "../fixtures/mapnav/index.ts": () => import("./index-DB8bbJNH.js"), "../fixtures/metadata/index.ts": () => import("./index-C-WuFxXA.js"), "../fixtures/northarrow/index.ts": () => import("./index-Bx3kjnaq.js"), "../fixtures/overviewmap/index.ts": () => import("./index-BM_ZFD_Q.js"), "../fixtures/panguard/index.ts": () => import("./index-CUEX4rx4.js"), "../fixtures/scrollguard/index.ts": () => import("./index-BmFj0wSJ.js"), "../fixtures/settings/index.ts": () => import("./index-DSmKTGmD.js"), "../fixtures/snowman/index.ts": () => import("./index-Dor164wk.js"), "../fixtures/wizard/index.ts": () => import("./index-DG5bt87k.js") });
class Pn extends J {
  /**
...
const Un = /* @__PURE__ */ Ne(Dn, [["render", Gn], ["__scopeId", "data-v-a3c61802"]]), Bn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-DLQIbOoP.js"), "../fixtures/basemap/screen.vue": () => import("./screen-CLuJrsYK.js"), "../fixtures/export/screen.vue": () => import("./screen-t_vQujhZ.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-Cn08zr6H.js"), "../fixtures/grid/screen.vue": () => import("./screen-BYg929BY.js"), "../fixtures/help/screen.vue": () => import("./screen-DVYKVK45.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-BPGdn5oT.js"), "../fixtures/legend/screen.vue": () => import("./screen-Ds7rvJvs.js"), "../fixtures/metadata/screen.vue": () => import("./screen-CnUaDabe.js"), "../fixtures/settings/screen.vue": () => import("./screen-CgZZhiq_.js"), "../fixtures/wizard/screen.vue": () => import("./screen-Dm6a0Njq.js") });
class Et extends J {
  /**
   * ID of this panel.
   *
...
var rt = { major: "4", minor: "12", patch: "0-beta", timestamp: "Tue May 27 17:30:12 2025 -0400", hash: "86b9c46614d37eed2809f6ad9eca64c187cf34b1" };
console.info(
