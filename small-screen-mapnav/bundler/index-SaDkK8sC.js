...
import { _ as H, d as L, F as K, G as X } from "./main-BGHE-k5O.js";
...
const W = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ O({
  ...
  setup(b) {
    const i = S("iApi"), { t } = N(), o = ee(), p = [
      {
        type: "point",
        icon: f(g(() => import("./point-icon-DE9Dc-BV.js")))
      },
      {
        type: "polyline",
        icon: f(g(() => import("./polyline-icon-EgaJ1VjW.js")))
      },
      {
        type: "polygon",
        icon: f(g(() => import("./polygon-icon-D7zk2R1x.js")))
      },
      {
        type: "circle",
        icon: f(g(() => import("./circle-icon-BQiWrGwd.js")))
      },
      {
        type: "rectangle",
        icon: f(g(() => import("./rectangle-icon-B3WHTWY5.js")))
      }
    ], a = E(() => {
      const s = p.filter((v) => o.supportedTypes.some((x) => x.type === v.type));
      return s.push({
        type: "edit",
        icon: f(g(() => import("./edit-icon-BmC3p0Hz.js")))
      }), s;
    }), n = (s) => {
