import { iO as A, iP as y, bx as M, fB as $, ha as O, fK as D, hb as B } from "./main-D7GaJzP1.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-oZCHCYSb.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-Dj4YfktV.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-DELrRjbO.js")).default, n = (await import("./index-DKLUwCyu.js")).default, a = (await import("./index-CLQz2BGu.js")).default, w = (await import("./index-Bc_EKxPh.js")).default, p = (await import("./index-YFMBP1Jd.js")).default, r = (await import("./index-CHlYIfKc.js")).default, b = (await import("./index-5g7GjtUF.js")).default;
...
//# sourceMappingURL=index--qrF9RZs.js.map
