import { hX as K, bh as D } from "./main-D7GaJzP1.js";
import { y as X } from "./DoubleArray-CSKy17gl.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-Be_mT8UH.js";
import { n as Z, s as ee } from "./vec3-C2fMHCyS.js";
import "./sphere-BK-Y5bgI.js";
import "./I3SUtil-DKCBsaaC.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-8DLHSKij.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-D7GaJzP1.js").then((d) => d.qK), import("./main-D7GaJzP1.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-CILuzvTa.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-B6pJMMOd.js.map
