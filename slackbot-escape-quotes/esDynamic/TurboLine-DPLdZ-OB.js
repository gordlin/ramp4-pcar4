import { af as le, hX as ue } from "./main-D7GaJzP1.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-DV1Qp1jn.js").then((i) => i.l) : await import("./libtess-BgGME-H3.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-DPLdZ-OB.js.map
