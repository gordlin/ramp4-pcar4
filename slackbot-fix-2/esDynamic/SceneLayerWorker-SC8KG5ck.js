import { hX as K, bh as D } from "./main-BDEhVfMj.js";
import { y as X } from "./DoubleArray-BW23Hl8M.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-CXf07J3g.js";
import { n as Z, s as ee } from "./vec3-CNgTRRl_.js";
import "./sphere-CbTc4J1-.js";
import "./I3SUtil-reOtg3Jy.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-C17ltOYr.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-BDEhVfMj.js").then((d) => d.qK), import("./main-BDEhVfMj.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-Ci2QZKAc.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-SC8KG5ck.js.map
