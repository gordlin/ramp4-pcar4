import { iO as A, iP as y, bx as M, fB as $, ha as O, fK as D, hb as B } from "./main-BDEhVfMj.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-BUsj7j-Z.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-Dyb5Vtng.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-BKSnLt9q.js")).default, n = (await import("./index-ChwBmeZ5.js")).default, a = (await import("./index-D6StWJv_.js")).default, w = (await import("./index-DBPwieiB.js")).default, p = (await import("./index-By4YAfyu.js")).default, r = (await import("./index-qwQR53No.js")).default, b = (await import("./index-CXbjH9YO.js")).default;
...
//# sourceMappingURL=index-BDEKc2S4.js.map
