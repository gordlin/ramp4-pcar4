import { af as le, hX as ue } from "./main-BDEhVfMj.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-DPZq8I6w.js").then((i) => i.l) : await import("./libtess-ClW1YzDT.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-DE7xKUz5.js.map
