...
import { p as T1, o as u, Z as A1, a as w1, a1 as p, G as _, _ as m1, L as z, Q as B1, n as E1, a3 as f, a4 as D, S as $1, a5 as J, a6 as r1 } from "./main-DOP6yDMI.js";
import "pinia";
...
const R1 = ["type", "aria-label", "checked", "disabled", "content"], c1 = /* @__PURE__ */ N({
  ...
  setup(e) {
    ...
    const w = (s) => !s.symbologyStack.some((I) => I.visibility), $ = () => {
      if (i.value instanceof T1)
        i.legendItem.toggleVisibility();
      else if (i.legendItem instanceof u) {
        if (w(i.legendItem) ? (i.legendItem.setSymbologyVisibility(void 0, !1), i.legendItem.setSymbologyVisibility(i.value.uid, !0), i.legendItem.toggleVisibility(!0)) : i.legendItem.setSymbologyVisibility(i.value.uid, !i.value.lastVisbility), w(i.legendItem) && i.legendItem.toggleVisibility(!1), i.legendItem.layer?.supportsFeatures) {
  ...
  emits: ["focusItem"],
  setup(e, { emit: d }) {
    const { t: i } = t1(), c = p1("iApi"), w = E(), $ = E(!1), s = w1(), I = E(s.mobileView), A = d, O = E(0), x = e, l1 = () => {
      ...
      if (x.legendItem.layerControlAvailable(p.Metadata) && S("metadata")) {
        const v = x.legendItem?.layer?.config.metadata || x.legendItem?.layer?.parentLayer?.config?.metadata || {}, y = v?.name || x.legendItem?.layer?.name || "", Q = x.legendItem?.layer?.config?.catalogueUrl || x.legendItem?.layer?.layerType === "sublayer" && x.legendItem?.layer?.parentLayer?.config?.catalogueUrl || void 0;
        if (v.url) {
    ...
    }, K = Z(() => x.legendItem.layerControlAvailable(p.Reload) && x.legendItem instanceof u && H(x.legendItem.layer)?.canReload), o1 = (v) => {
      $.value = !0, setTimeout(() => {
  ...
  setup(e) {
    ...
    return h1(() => {
      ...
      i.value.length > 1 ? (n(), a("div", W1, [
        (n(!0), a(d1, null, g1(i.value.slice(0, 3).reverse(), ($, s) => (n(), a("div", {
          class: M(["absolute", [s == 0 ? "symbol-0" : s == 1 ? "left-3 symbol-1" : "left-6 symbol-2"]]),
          style: C1({ "z-index": 3 - s }),
          key: s
        }, [
          i.value[s].svgcode ? (n(), a("span", {
            key: 0,
            class: "symbologyIcon w-28 h-28",
            innerHTML: i.value[s].svgcode
          }, null, 8, J1)) : i.value[s].imgUrl ? (n(), a("img", {
            key: 1,
            class: "symbologyIcon w-28 h-28",
            src: i.value[s].imgUrl
          }, null, 8, Y1)) : m("", !0)
        ], 6))), 128))
      ])) : i.value.length > 0 ? (n(), a("div", X1, [
        i.value[0].svgcode ? (n(), a("span", {
          key: 0,
          innerHTML: i.value[0].svgcode
        }, null, 8, _1)) : i.value[0].imgUrl ? (n(), a("img", {
          key: 1,
  ...
  setup(e) {
    const d = B1(), i = w1(), { t: c } = t1(), w = p1("iApi"), $ = E(), s = e, I = E1(), A = I.multilineItems, O = (s.legendItem instanceof u && s.legendItem.maxLines) ?? I.maxLines, x = E(i.mobileView), l1 = Z(() => d.layerConfigs), P = E([]), Y = E(!1), q = E(!1), X = z1("legendFocusItem"), n1 = Z(() => s.legendItem instanceof u ? H(s.legendItem.layer)?.layerType : ""), a1 = Z(() => s.legendItem instanceof u && H(s.legendItem.layer)?.canModifyLayer), K = Z(() => {
      if (s.legendItem instanceof u) {
        const r = H(s.legendItem.layer);
        return r ? r.canReload : !0;
      } else
        return !1;
    }), o1 = Z(() => w.animate), S = Z(() => s.legendItem.children.length > 0 || // TODO: Determine why Vue reactivity isn't picking updates to the children property of the parent.
    ...
    s.legendItem instanceof u && H(s.legendItem.layer)?.sublayers.length > 0), v = (r) => r === D.Expand || r === D.Visibility ? s.legendItem.controlAvailable(r) : s.legendItem.layerControlAvailable(r), y = (r) => P1(r), Q = () => {
      s.legendItem.children.length === 0 || !v(D.Expand) || (s.legendItem.toggleExpanded(), w.updateAlert(c(`legend.alert.group${s.legendItem.expanded ? "Expanded" : "Collapsed"}`)));
    }, F = () => {
      if (v(p.Symbology)) {
      ...
      v(p.Datatable) && W() && w.event.emit(_.GRID_TOGGLE, s.legendItem.layer);
    }, i1 = (r) => {
      ...
      if (r.type === f.Error) {
        ...
        const L = setInterval(() => {
          ...
          V && (clearInterval(L), V.cancelLoad(), (w.fixture.get("legend")?.getLayerBoundItems(V) || []).forEach((s1) => s1.error())), l > 1200 && clearInterval(L), l++;
        }, 50);
      }
    }, y1 = () => {
    ...
    return s.legendItem instanceof u && (y1(), S1(
      ...
      const L = x1("item", !0), k = G("tippy"), V = G("truncate"), U = G("focus-item"), s1 = G("focus-list");
        ...
        o("div", re, [
          b((n(), a("div", {
            class: M(["flex items-center hover:bg-gray-200 default-focus-style !p-5", [
              ...
              S.value && v(t(D).Expand) || !S.value && e.legendItem instanceof t(u) && v(t(p).Datatable) && W() && e.legendItem.type === t(f).Item ? "cursor-pointer" : "cursor-default",
            ...
            onClick: l[19] || (l[19] = () => {
              !S.value && e.legendItem instanceof t(u) && v(t(p).Datatable) && W() && e.legendItem.type === t(f).Item ? B() : S.value && Q();
            }),
            content: S.value && v(t(D).Expand) ? t(c)(e.legendItem.expanded ? "legend.group.collapse" : "legend.group.expand") : e.legendItem instanceof t(u) && e.legendItem.type === t(f).Item && v(t(p).Datatable) && W() ? t(c)("legend.layer.data") : "",
            "truncate-trigger": "",
            ...
            e.legendItem instanceof t(u) && t(A) ? b((n(), a("div", {
              ...
              e.legendItem.type !== t(f).Placeholder ? b((n(), a("div", {
                ...
                e.legendItem instanceof t(u) && v(t(p).Datatable) && W() && e.legendItem.type === t(f).Item ? b((n(), T(e1, {
                  key: 0,
                  label: "",
            ...
            ])) : e.legendItem.type === t(f).Item && v(t(D).Visibility) ? (n(), T(c1, {
              key: 12,
