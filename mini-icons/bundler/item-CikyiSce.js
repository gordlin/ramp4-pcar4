import { defineComponent as N, ref as E, onMounted as h1, resolveDirective as G, openBlock as n, createElementBlock as a, withModifiers as h, withDirectives as b, createElementVNode as o, unref as t, withKeys as v1, normalizeClass as M, inject as p1, computed as Z, toRaw as H, resolveComponent as x1, createBlock as T, withCtx as j, createTextVNode as R, toDisplayString as C, Fragment as d1, renderList as g1, normalizeStyle as C1, createCommentVNode as m, renderSlot as M1, useTemplateRef as z1, watch as S1, createStaticVNode as u1, createVNode as V1, resolveDynamicComponent as H1 } from "vue";
import { p as T1, o as u, Z as A1, a as w1, a1 as p, G as _, _ as m1, L as z, Q as B1, n as E1, a3 as f, a4 as D, S as $1, a5 as J, a6 as r1 } from "./main-Dg8Mrowh.js";
import "pinia";
import { useI18n as t1 } from "vue-i18n";
import "screenfull";
...
import "csv2geojson";
import "redaxios";
import Z1 from "await-to-js";
import "svg.js";
import { marked as P1 } from "marked";
const R1 = ["type", "aria-label", "checked", "disabled", "content"], c1 = /* @__PURE__ */ N({
  __name: "checkbox",
  props: {
    value: {
      type: Object,
  ...
  setup(e) {
    const { t: d } = t1(), s = e, c = E(s.legendItem.visibility);
    h1(() => {
      s.legendItem.checkVisibilityRules(), c.value = s.legendItem.visibility === s.checked;
    });
    const w = (i) => !i.symbologyStack.some((I) => I.visibility), $ = () => {
      if (s.value instanceof T1)
        s.legendItem.toggleVisibility();
      else if (s.legendItem instanceof u) {
        if (w(s.legendItem) ? (s.legendItem.setSymbologyVisibility(void 0, !1), s.legendItem.setSymbologyVisibility(s.value.uid, !0), s.legendItem.toggleVisibility(!0)) : s.legendItem.setSymbologyVisibility(s.value.uid, !s.value.lastVisbility), w(s.legendItem) && s.legendItem.toggleVisibility(!1), s.legendItem.layer?.supportsFeatures) {
          const i = s.legendItem.symbologyStack.filter((A) => A.lastVisbility === !0).map((A) => A.definitionClause || "");
          let I = "";
          i.length === 0 ? I = "1=2" : i.length < s.legendItem.symbologyStack.length && (I = i.join(" OR ")), s.legendItem.layer?.setSqlFilter(A1.SYMBOL, I);
        }
        c.value = !0;
      }
    };
    return (i, I) => {
      ...
      return n(), a("div", {
        class: "relative",
        onMouseover: I[3] || (I[3] = h(() => {
        }, ["stop"]))
      }, [
        b(o("input", {
          type: e.isRadio ? "radio" : "checkbox",
          "aria-label": t(d)(e.checked ? `legend.visibility.hide${e.label}` : `legend.visibility.show${e.label}`),
          onClick: I[0] || (I[0] = h((O) => $(), ["stop"])),
          checked: e.checked && c.value,
          onKeypress: I[1] || (I[1] = v1(h(() => {
          }, ["prevent"]), ["enter"])),
          onKeyup: I[2] || (I[2] = v1(h((O) => $(), ["stop"]), ["enter"])),
          class: M([[
            e.disabled ? "text-gray-400 border-gray-300" : "text-black cursor-pointer border-gray-500 hover:border-black"
          ], "mx-5 h-15 w-15"]),
          tabindex: "-1",
          disabled: e.disabled,
          content: t(d)(e.checked ? `legend.visibility.hide${e.label}` : `legend.visibility.show${e.label}`)
        }, null, 42, R1), [
          [A, { placement: "top-end", hideOnClick: !1 }]
        ])
      ], 32);
    };
  }
}), G1 = ["aria-label"], U1 = ["aria-label"], D1 = ["aria-label"], O1 = ["aria-label"], F1 = ["aria-label"], j1 = ["aria-label"], N1 = ["content", "aria-label"], q1 = /* @__PURE__ */ N({
  ...
  emits: ["focusItem"],
  setup(e, { emit: d }) {
    const { t: s } = t1(), c = p1("iApi"), w = E(), $ = E(!1), i = w1(), I = E(i.mobileView), A = d, O = E(0), x = e, l1 = () => {
      x.legendItem.layerControlAvailable(p.Symbology) && x.legendItem.toggleSymbology();
    }, P = () => {
      x.legendItem.layerControlAvailable(p.Datatable) && S("grid") && c.event.emit(_.GRID_TOGGLE, x.legendItem.layer);
    }, Y = () => {
      x.legendItem.layerControlAvailable(p.Settings) && S("settings") && c.event.emit(_.SETTINGS_TOGGLE, x.legendItem.layer);
    }, q = () => {
      if (x.legendItem.layerControlAvailable(p.Metadata) && S("metadata")) {
        const y = x.legendItem?.layer?.config.metadata || x.legendItem?.layer?.parentLayer?.config?.metadata || {}, v = y?.name || x.legendItem?.layer?.name || "", Q = x.legendItem?.layer?.config?.catalogueUrl || x.legendItem?.layer?.layerType === "sublayer" && x.legendItem?.layer?.parentLayer?.config?.catalogueUrl || void 0;
        if (y.url) {
          const F = y.url.split("."), B = F[F.length - 1], s1 = B === "xml" || B === "md" ? B : "html";
          c.event.emit(_.METADATA_TOGGLE, {
            type: s1,
            layerName: v,
            url: y.url,
            catalogueUrl: Q,
            layer: x.legendItem.layer,
            xmlType: y.xmlType,
            treatXmlAsMarkdown: y.treatXmlAsMarkdown
          });
        } else
          console.warn("Layer does not have a metadata url defined");
      }
    }, X = () => {
      x.legendItem.layerControlAvailable(p.BoundaryZoom) && x.legendItem?.layer?.zoomToLayerBoundary();
    }, n1 = () => {
      x.legendItem.layerControlAvailable(p.Remove) && c.geo.map.removeLayer(x.legendItem.layerUid);
    }, a1 = (y) => {
      K.value && H(x.legendItem.layer).reload().then(() => {
        O.value += 1, y.pointerType !== "mouse" && A("focusItem");
      });
    }, K = Z(() => x.legendItem.layerControlAvailable(p.Reload) && x.legendItem instanceof u && H(x.legendItem.layer)?.canReload), o1 = (y) => {
      $.value = !0, setTimeout(() => {
        $.value && (I.value || y._tippy?.show());
      }, 300);
    }, S = (y) => {
      try {
        return c.fixture.exists(y);
      } catch {
        return !1;
      }
    };
    return (y, v) => {
      const Q = x1("dropdown-menu"), F = G("tippy");
      return n(), a("div", {
        onClick: v[3] || (v[3] = h(() => {
        }, ["stop"])),
        onMouseover: v[4] || (v[4] = h(() => {
        }, ["stop"])),
        ...
        (n(), T(Q, {
          class: "flex-shrink-0",
          position: "bottom-end",
          tooltip: t(s)("legend.layer.options"),
          ...
          default: j(() => [
            o("a", {
              href: "javascript:;",
              class: M(["flex leading-snug items-center text-left w-auto", {
                disabled: !e.legendItem.layerControlAvailable(t(p).Metadata) || !S("metadata")
              }]),
              onClick: q,
              role: "button",
              "aria-label": t(s)("legend.layer.controls.metadata")
            }, [
              v[6] || (v[6] = o("svg", {
                class: "setting-svg",
                viewBox: "0 0 23 21"
              ...
              R(" " + C(t(s)("legend.layer.controls.metadata")), 1)
            ], 10, G1),
            o("a", {
              href: "javascript:;",
              class: M(["flex leading-snug items-center text-left w-auto", {
                disabled: !e.legendItem.layerControlAvailable(t(p).Settings) || !S("settings")
              }]),
              onClick: Y,
              role: "button",
              "aria-label": t(s)("legend.layer.controls.settings")
            }, [
              v[7] || (v[7] = o("svg", {
                class: "setting-svg",
                viewBox: "0 0 23 21"
              ...
              R(" " + C(t(s)("legend.layer.controls.settings")), 1)
            ], 10, U1),
            o("a", {
              href: "javascript:;",
              class: M(["flex leading-snug items-center text-left w-auto", {
                disabled: !e.legendItem.layerControlAvailable(t(p).Datatable) || !S("grid")
              }]),
              onClick: P,
              role: "button",
              "aria-label": t(s)("legend.layer.controls.datatable")
            }, [
              v[8] || (v[8] = o("svg", {
                class: "setting-svg",
                viewBox: "0 0 23 21"
              ...
              R(" " + C(t(s)("legend.layer.controls.datatable")), 1)
            ], 10, D1),
            o("a", {
              href: "javascript:;",
              class: M(["flex leading-snug items-center text-left w-auto", {
                disabled: !e.legendItem.layerControlAvailable(t(p).Symbology)
              }]),
              onClick: l1,
              role: "button",
              "aria-label": t(s)("legend.layer.controls.symbology")
            }, [
              v[9] || (v[9] = o("svg", {
                class: "setting-svg",
                viewBox: "0 0 23 21"
              ...
              R(" " + C(t(s)("legend.layer.controls.symbology")), 1)
            ], 10, O1),
            o("a", {
              href: "javascript:;",
              class: M(["flex leading-snug items-center text-left w-auto", {
                disabled: !e.legendItem.layerControlAvailable(t(p).BoundaryZoom)
              }]),
              onClick: X,
              role: "button",
              "aria-label": t(s)("legend.layer.controls.boundaryzoom")
            }, [
              v[10] || (v[10] = o("svg", {
                class: "setting-svg",
                viewBox: "0 0 24 24"
              ...
              R(" " + C(t(s)("legend.layer.controls.boundaryzoom")), 1)
            ], 10, F1),
            o("a", {
              href: "javascript:;",
              class: M(["flex leading-snug items-center text-left w-auto", {
                disabled: !e.legendItem.layerControlAvailable(t(p).Remove)
              }]),
              onClick: n1,
              role: "button",
              "aria-label": t(s)("legend.layer.controls.remove")
            }, [
              v[11] || (v[11] = o("svg", {
                class: "setting-svg",
                viewBox: "0 0 23 21"
              ...
              R(" " + C(t(s)("legend.layer.controls.remove")), 1)
            ], 10, j1),
            b((n(), a("a", {
              href: "javascript:;",
              class: M(["flex leading-snug items-center text-left w-auto", {
              ...
              content: K.value ? "" : t(s)("legend.layer.controls.reloadDisabled"),
              onMouseover: v[0] || (v[0] = h((B) => o1(B.currentTarget), ["stop"])),
              onMouseout: v[1] || (v[1] = (B) => (
                //@ts-expect-error TODO: explain why this is needed or remove
                (I.value || B.currentTarget?._tippy?.hide(), $.value = !1)
              )),
              onClick: v[2] || (v[2] = (B) => a1(B)),
              role: "button",
              "aria-label": t(s)("legend.layer.controls.reload")
            }, [
              v[12] || (v[12] = o("svg", {
                class: "setting-svg",
                viewBox: "0 0 24 24"
              ...
              R(" " + C(t(s)("legend.layer.controls.reload")), 1)
            ], 42, N1)), [
              [F, {
                placement: "top-start",
...
}), K1 = /* @__PURE__ */ m1(q1, [["__scopeId", "data-v-d623c1ee"]]), Q1 = { key: 0 }, W1 = {
  key: 0,
  class: "relative left-3"
}, J1 = ["innerHTML"], Y1 = ["src"], X1 = {
  key: 1,
  class: "symbologyIcon w-32 h-32"
}, _1 = ["innerHTML"], ee = ["src"], te = {
  key: 1,
  ...
  setup(e) {
    const d = e, s = E([]);
    return h1(() => {
      d.legendItem.loadPromise.then(() => {
        d.legendItem.layerUid !== void 0 && Promise.all(H(d.legendItem.symbologyStack).map((c) => c.drawPromise)).then(() => {
          s.value = H(d.legendItem).symbologyStack;
        });
      });
    }), (c, w) => e.visible ? (n(), a("div", te, w[0] || (w[0] = [
      o("svg", {
      ...
      s.value.length > 1 ? (n(), a("div", W1, [
        (n(!0), a(d1, null, g1(s.value.slice(0, 3).reverse(), ($, i) => (n(), a("div", {
          class: M(["absolute", [i == 0 ? "symbol-0" : i == 1 ? "left-3 symbol-1" : "left-6 symbol-2"]]),
          style: C1({ "z-index": 3 - i }),
          key: i
        }, [
          s.value[i].svgcode ? (n(), a("span", {
            key: 0,
            class: "symbologyIcon w-28 h-28",
            innerHTML: s.value[i].svgcode
          }, null, 8, J1)) : s.value[i].imgUrl ? (n(), a("img", {
            key: 1,
            class: "symbologyIcon w-28 h-28",
            src: s.value[i].imgUrl
          }, null, 8, Y1)) : m("", !0)
        ], 6))), 128))
      ])) : s.value.length > 0 ? (n(), a("div", X1, [
        s.value[0].svgcode ? (n(), a("span", {
          key: 0,
          innerHTML: s.value[0].svgcode
        }, null, 8, _1)) : s.value[0].imgUrl ? (n(), a("img", {
          key: 1,
...
}), ne = /* @__PURE__ */ m1(le, [["__scopeId", "data-v-34dfeccd"]]), ae = {
  class: "default-focus-style break-words text-ellipsis text-[10px] border rounded px-3 min-h-[18px] w-max hover:border-gray-600 hover:bg-gray-300 bg-none border-transparent flex items-center gap-2",
  style: { color: "rgba(0, 0, 0, 0.75)", fill: "rgba(0, 0, 0, 0.75)" }
}, oe = { key: 0 }, e1 = /* @__PURE__ */ N({
  __name: "mini-icon",
  props: {
    label: String
  },
  setup(e) {
    return (d, s) => {
      ...
      return b((n(), a("div", ae, [
        M1(d.$slots, "default"),
        e.label ? (n(), a("label", oe, C(e.label), 1)) : m("", !0)
      ])), [
        [c, { placement: "bottom-start" }]
      ]);
    };
  }
}), se = ["innerHTML"], ie = /* @__PURE__ */ N({
  __name: "layertype-icon",
  props: {
    layerType: { type: String, required: !0 },
    featureCount: { type: Number }
  },
  setup(e) {
    const { t: d } = t1(), s = e, c = Z(
      () => s.featureCount ? ` (${d("legend.layer.features.count", s.featureCount)})` : ""
    ), w = Z(() => {
      switch (s.layerType) {
        case z.FEATURE:
          return [
            d("legend.layer.type.ESRIFeature"),
            `<svg
                    version="1.1"
                    id="Layer_1"
                    xmlns="http://www.w3.org/2000/svg"
        ...
        case z.MAPIMAGE:
          return [
            d("legend.layer.type.ESRIMapImage"),
            `<svg
                    version="1.1"
                    width="12px"
                    height="12px"
        ...
        case z.IMAGERY:
          return [
            d("legend.layer.type.ESRIImagery"),
            `<svg
                    version="1.1"
                    width="12px"
                    height="12px"
        ...
        case z.GRAPHIC:
          return [
            d("legend.layer.type.ESRIGraphic"),
            `<svg
                    version="1.1"
                    xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    return ($, i) => {
      const I = G("tippy");
      return b((n(), T(e1, {
        label: e.featureCount ? e.featureCount.toString() : "",
        content: w.value[0] + c.value
      }, {
        default: j(() => [
          o("div", {
            innerHTML: w.value[1]
        ...
        [I, { placement: "bottom-start" }]
      ]);
    };
  }
}), re = { class: "relative" }, ce = ["content"], de = {
  key: 0,
  ...
  width: "24px",
  height: "24px"
}, ye = ["disabled", "content", "aria-label"], ve = ["src"], ue = { class: "pointer-events-none" }, he = { class: "flex-auto pointer-events-none p-5 truncate" }, pe = { class: "h-auto break-words text-ellipsis" }, xe = {
  class: "fill-gray-800",
  version: "1.1",
  id: "Layer_1",
  xmlns: "http://www.w3.org/2000/svg",
...
}, ke = { key: 1 }, Ce = { key: 2 }, Me = ["src"], ze = ["innerHTML"], Se = {
  key: 6,
  class: "relative"
}, Ve = ["content", "aria-label"], He = {
  key: 8,
  class: "relative"
}, Te = ["content", "aria-label"], Ae = { class: "flex p-5" }, Be = {
  key: 0,
  ...
  key: 1,
  class: "symbologyIcon"
}, Xe = ["innerHTML"], _e = { class: "flex-1 ml-15" }, e2 = { key: 1 }, t2 = { class: "flex p-5 ml-48" }, l2 = {
  key: 0,
  class: "relative animate-spin spinner h-20 w-20 mr-10 pt-2"
}, n2 = { class: "flex-1 text-gray-500" }, a2 = {
  key: 1,
  ...
  setup(e) {
    const d = B1(), s = w1(), { t: c } = t1(), w = p1("iApi"), $ = E(), i = e, I = E1(), A = I.multilineItems, O = (i.legendItem instanceof u && i.legendItem.maxLines) ?? I.maxLines, x = E(s.mobileView), l1 = Z(() => d.layerConfigs), P = E([]), Y = E(!1), q = E(!1), X = z1("legendFocusItem"), n1 = Z(() => i.legendItem instanceof u ? H(i.legendItem.layer)?.layerType : ""), a1 = Z(() => i.legendItem instanceof u && H(i.legendItem.layer)?.canModifyLayer), K = Z(() => {
      if (i.legendItem instanceof u) {
        const r = H(i.legendItem.layer);
        return r ? r.canReload : !0;
      } else
        return !1;
    }), o1 = Z(() => w.animate), S = Z(() => i.legendItem.children.length > 0 || // TODO: Determine why Vue reactivity isn't picking updates to the children property of the parent.
    ...
    i.legendItem instanceof u && H(i.legendItem.layer)?.sublayers.length > 0), y = (r) => r === D.Expand || r === D.Visibility ? i.legendItem.controlAvailable(r) : i.legendItem.layerControlAvailable(r), v = (r) => P1(r), Q = () => {
      i.legendItem.children.length === 0 || !y(D.Expand) || (i.legendItem.toggleExpanded(), w.updateAlert(c(`legend.alert.group${i.legendItem.expanded ? "Expanded" : "Collapsed"}`)));
    }, F = () => {
      if (y(p.Symbology)) {
        const r = i.legendItem.toggleSymbology();
        w.updateAlert(c(`legend.alert.symbology${r ? "Expanded" : "Collapsed"}`));
      }
    }, B = () => {
      y(p.Datatable) && W() && w.event.emit(_.GRID_TOGGLE, i.legendItem.layer);
    }, s1 = (r) => {
      const l = document.createElement("span");
      l.innerHTML = r.svgcode;
      const L = l.firstElementChild;
      return L?.classList.add("max-w-full"), L?.classList.add("h-full"), L?.setAttribute("height", r.imgHeight), L?.setAttribute("width", r.imgWidth), l.outerHTML;
    }, W = () => {
      try {
      ...
      i.legendItem.reload(), setTimeout(() => {
        ...
        let l = !0;
        if (r.layer)
          H(r.layer).reload(), l = !1;
        else if (r.isSublayer && r.parentLayerId) {
          const L = w.geo.layer.getLayer(r.parentLayerId);
          L && (H(L).reload(), l = !1);
        }
        if (l) {
          const L = r.isSublayer ? r.parentLayerId : r.layerId, k = l1.value.find((V) => V.id === L);
          k !== void 0 && b1(k);
        }
      ...
      try {
        const l = w.geo.layer.getLayer(r.id);
        if (l) {
          const [L] = await Z1(H(l).reload());
          if (L)
            throw new Error();
          return l;
        } else {
          const L = w.geo.layer.createLayer(r);
          return await w.geo.map.addLayer(L).catch(() => {
            throw new Error();
          }), L;
        }
      } catch {
      ...
      const r = H(i.legendItem);
      let l = 0;
      if (r.type === f.Error) {
        i.legendItem.toggleHidden(!0);
        const L = setInterval(() => {
          const k = r.layer;
          (k && (k.layerExists || k.initiationState === r1.NEW || k.initiationState === r1.TERMINATING || k.initiationState === r1.TERMINATED) || l > 1200) && (clearInterval(L), k && w.geo.map.removeLayer(k), d.removeLayerConfig(r.layerId), w.fixture.get("legend")?.removeLayerItem(r.layerId)), l++;
        }, 250);
      } else {
        i.legendItem.error();
        const L = setInterval(() => {
          const k = r.parentLayerId || r.layerId, V = w.geo.layer.getLayer(k);
          V && (clearInterval(L), V.cancelLoad(), (w.fixture.get("legend")?.getLayerBoundItems(V) || []).forEach((i1) => i1.error())), l > 1200 && clearInterval(L), l++;
        }, 50);
      }
    }, y1 = () => {
      i.legendItem.loadPromise.then(() => {
        if (P.value = [], !i.legendItem.layer) {
          console.warn("Attempted to mount legend item component with undefined layer");
          return;
        }
        Promise.all(
          H(i.legendItem.symbologyStack.map((r) => r.drawPromise))
        ).then(() => {
          P.value = i.legendItem.symbologyStack, Y.value = !0;
        });
      }).catch(() => {
      });
    }, L1 = (r) => {
      q.value = !0, setTimeout(() => {
        q.value && (x.value || r._tippy?.show());
      }, 300);
    };
    return i.legendItem instanceof u && (y1(), S1(
      () => i.legendItem.symbologyStack,
      () => {
        y1();
      }
    )), (r, l) => {
      const L = x1("item", !0), k = G("tippy"), V = G("truncate"), U = G("focus-item"), i1 = G("focus-list");
      return e.legendItem.hidden ? m("", !0) : (n(), a("div", {
        ...
        o("div", re, [
          b((n(), a("div", {
            class: M(["flex items-center hover:bg-gray-200 default-focus-style !p-5", [
              e.legendItem.type === t(f).Item ? "loaded-item" : e.legendItem.type === t(f).Error ? "non-loaded-item bg-red-200" : "non-loaded-item",
              S.value && y(t(D).Expand) || !S.value && e.legendItem instanceof t(u) && y(t(p).Datatable) && W() && e.legendItem.type === t(f).Item ? "cursor-pointer" : "cursor-default",
              t(A) ? "multilined" : "singlelined"
            ]]),
            onMouseover: l[17] || (l[17] = h((g) => L1(g.currentTarget), ["stop"])),
            onMouseout: l[18] || (l[18] = (g) => (
              //@ts-expect-error TODO: explain why this is needed or remove
              (x.value || g.currentTarget?._tippy?.hide(), q.value = !1)
            )),
            onClick: l[19] || (l[19] = () => {
              !S.value && e.legendItem instanceof t(u) && y(t(p).Datatable) && W() && e.legendItem.type === t(f).Item ? B() : S.value && Q();
            }),
            content: S.value && y(t(D).Expand) ? t(c)(e.legendItem.expanded ? "legend.group.collapse" : "legend.group.expand") : e.legendItem instanceof t(u) && e.legendItem.type === t(f).Item && y(t(p).Datatable) && W() ? t(c)("legend.layer.data") : "",
            "truncate-trigger": "",
            ref_key: "legendFocusItem",
            ref: X
          }, [
            e.legendItem.type !== t(f).Item ? (n(), a("div", de, [
              e.legendItem.type === t(f).Placeholder ? (n(), a("svg", ge, l[21] || (l[21] = [
                u1('<path d="M0 0h24v24H0V0z" fill="none" data-v-88992eac></path><path d="M0 0h24v24H0V0z" fill="none" data-v-88992eac></path><circle cx="15.5" cy="9.5" r="1.5" data-v-88992eac></circle><circle cx="8.5" cy="9.5" r="1.5" data-v-88992eac></circle><circle cx="15.5" cy="9.5" r="1.5" data-v-88992eac></circle><circle cx="8.5" cy="9.5" r="1.5" data-v-88992eac></circle><path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm0-2.5c2.33 0 4.32-1.45 5.12-3.5h-1.67c-.69 1.19-1.97 2-3.45 2s-2.75-.81-3.45-2H6.88c.8 2.05 2.79 3.5 5.12 3.5z" data-v-88992eac></path>', 7)
              ]))) : (n(), a("svg", me, l[22] || (l[22] = [
                u1('<path d="M0 0h24v24H0V0z" fill="none" data-v-88992eac></path><path d="M0 0h24v24H0V0z" fill="none" data-v-88992eac></path><circle cx="15.5" cy="9.5" r="1.5" data-v-88992eac></circle><circle cx="8.5" cy="9.5" r="1.5" data-v-88992eac></circle><circle cx="15.5" cy="9.5" r="1.5" data-v-88992eac></circle><circle cx="8.5" cy="9.5" r="1.5" data-v-88992eac></circle><path d="M 20,12C 20,7.6 16.4,4 12,4C 7.6,4 4,7.6 4,12C 4,16.4 7.6,20 12,20C 16.4,20 20,16.4 20,12 Z M 22,12C 22,17.5 17.5,22 12,22C 6.5,22 2,17.5 2,12C 2,6.5 6.5,2.00001 12,2.00001C 17.5,2.00001 22,6.5 22,12 Z M 15.5,8C 16.3,8 17,8.7 17,9.5C 17,10.3 16.3,11 15.5,11C 14.7,11 14,10.3 14,9.5C 14,8.7 14.7,8 15.5,8 Z M 10,9.5C 10,10.3 9.3,11 8.5,11C 7.7,11 7,10.3 7,9.5C 7,8.7 7.7,8 8.5,8C 9.3,8 10,8.7 10,9.5 Z M 12,14C 13.7524,14 15.2943,14.7212 16.1871,15.8129L 14.7697,17.2302C 14.3175,16.5078 13.2477,16 12,16C 10.7523,16 9.68254,16.5078 9.23024,17.2302L 7.81291,15.8129C 8.7057,14.7212 10.2476,14 12,14 Z" data-v-88992eac></path>', 7)
              ])))
            ])) : m("", !0),
            e.legendItem.type === t(f).Item && e.legendItem instanceof t(u) && e.legendItem.layer.legend.length > 0 ? (n(), a("div", {
              key: 1,
              class: "relative w-32 h-32 mr-15",
              onMouseover: l[0] || (l[0] = h(() => {
              }, ["stop"]))
            }, [
              b((n(), a("button", {
                type: "button",
                onClick: h(F, ["stop"]),
                class: M([y(t(p).Symbology) ? "cursor-pointer" : "cursor-default"]),
                disabled: !y(t(p).Symbology),
                content: e.legendItem instanceof t(u) && e.legendItem.symbologyExpanded ? t(c)("legend.symbology.hide") : t(c)("legend.symbology.expand"),
                "aria-label": e.legendItem instanceof t(u) && e.legendItem.symbologyExpanded ? t(c)("legend.symbology.hide") : t(c)("legend.symbology.expand")
              }, [
                e.legendItem.coverIcon ? (n(), a("img", {
                  key: 1,
                  class: M([{
                    "pointer-events-none": !y(t(p).Symbology)
            ...
            S.value && y(t(D).Expand) ? (n(), a("div", {
              key: 2,
              class: M(["expand-toggle p-8 pointer-events-none", { "rotate-180": e.legendItem.expanded }])
            }, l[23] || (l[23] = [
              o("svg", {
                xmlns: "http://www.w3.org/2000/svg",
                height: "18",
            ...
            e.legendItem instanceof t(u) && t(A) ? b((n(), a("div", {
              key: 3,
              class: M(["flex flex-1 flex-col p-5", `line-clamp-${t(O)}`])
            }, [
              o("div", ue, [
                b((n(), a("div", he, [
                  o("span", pe, C(e.legendItem.name ?? (e.legendItem?.layer?.name ? e.legendItem.layer?.name : e.legendItem.layerId)), 1)
                ])), [
                  [V, {
                    externalTrigger: !0,
                    noTruncateClass: !0
              ...
              e.legendItem.type !== t(f).Placeholder ? b((n(), a("div", {
                key: 0,
                class: "ml-5 flex-none text-[11px] flex flex-row gap-2 mt-[-5px] flex-wrap w-fit",
                onMouseover: l[7] || (l[7] = h(() => {
                }, ["stop"]))
              }, [
                b(V1(ie, {
                  layerType: e.legendItem.layer?.layerType,
                  featureCount: e.legendItem.layer?.featureCount,
                  onKeypress: l[1] || (l[1] = h(() => {
                  }, ["stop"])),
                  onClick: l[2] || (l[2] = h(() => {
                  }, ["stop"]))
                ...
                e.legendItem instanceof t(u) && y(t(p).Datatable) && W() && e.legendItem.type === t(f).Item ? b((n(), T(e1, {
                  key: 0,
                  label: "",
                  content: "Datatable available (click to view)"
                }, {
                  default: j(() => [
                    (n(), a("svg", xe, l[24] || (l[24] = [
                      o("g", null, [
                        o("path", {
                          class: "st0",
                          "fill-rule": "evenodd",
                ...
                e.legendItem._visibility ? b((n(), T(e1, {
                  key: 1,
                  label: "",
                  content: e.legendItem.layer?.canIdentify() ? "Identify available (click map)" : "Identify disabled or unavailable",
                  onKeypress: l[3] || (l[3] = h(() => {
                  }, ["stop"])),
                  onClick: l[4] || (l[4] = h(() => {
                  }, ["stop"]))
                }, {
                  default: j(() => [
                    (n(), a("svg", {
                      class: M([e.legendItem.layer?.canIdentify() ? "fill-current" : "fill-red-500"]),
                      version: "1.1",
                      id: "Layer_1",
                      xmlns: "http://www.w3.org/2000/svg",
                      "xmlns:xlink": "http://www.w3.org/1999/xlink",
                      ...
                      o("g", null, [
                        o("path", { d: "M49.988,0h0.016v0.007C63.803,0.011,76.298,5.608,85.34,14.652c9.027,9.031,14.619,21.515,14.628,35.303h0.007v0.033v0.04 h-0.007c-0.005,5.557-0.917,10.905-2.594,15.892c-0.281,0.837-0.575,1.641-0.877,2.409v0.007c-1.446,3.66-3.315,7.12-5.547,10.307 l29.082,26.139l0.018,0.016l0.157,0.146l0.011,0.011c1.642,1.563,2.536,3.656,2.649,5.78c0.11,2.1-0.543,4.248-1.979,5.971 l-0.011,0.016l-0.175,0.203l-0.035,0.035l-0.146,0.16l-0.016,0.021c-1.565,1.642-3.654,2.534-5.78,2.646 c-2.097,0.111-4.247-0.54-5.971-1.978l-0.015-0.011l-0.204-0.175l-0.029-0.024L78.761,90.865c-0.88,0.62-1.778,1.209-2.687,1.765 c-1.233,0.755-2.51,1.466-3.813,2.115c-6.699,3.342-14.269,5.222-22.272,5.222v0.007h-0.016v-0.007 c-13.799-0.004-26.296-5.601-35.338-14.645C5.605,76.291,0.016,63.805,0.007,50.021H0v-0.033v-0.016h0.007 c0.004-13.799,5.601-26.296,14.645-35.338C23.683,5.608,36.167,0.016,49.955,0.007V0H49.988L49.988,0z M50.004,11.21v0.007h-0.016 h-0.033V11.21c-10.686,0.007-20.372,4.35-27.384,11.359C15.56,29.578,11.213,39.274,11.21,49.973h0.007v0.016v0.033H11.21 c0.007,10.686,4.347,20.367,11.359,27.381c7.009,7.012,16.705,11.359,27.403,11.361v-0.007h0.016h0.033v0.007 c10.686-0.007,20.368-4.348,27.382-11.359c7.011-7.009,11.358-16.702,11.36-27.4h-0.006v-0.016v-0.033h0.006 c-0.006-10.686-4.35-20.372-11.358-27.384C70.396,15.56,60.703,11.213,50.004,11.21L50.004,11.21z" })
                      ], -1)
                    ]), 2)),
                    e.legendItem.layer?.canIdentify() ? m("", !0) : (n(), a("svg", we, l[26] || (l[26] = [
                      o("g", null, [
                        o("path", {
                          fill: "#FF4141",
                ...
                e.legendItem.layer?.userAdded ? b((n(), T(e1, {
                  key: 2,
                  label: "User",
                  content: "User-added layer (will not save across sessions)",
                  onKeypress: l[5] || (l[5] = h(() => {
                  }, ["stop"])),
                  onClick: l[6] || (l[6] = h(() => {
                  }, ["stop"]))
                }, {
                  default: j(() => [
                    (n(), a("svg", fe, l[27] || (l[27] = [
                      o("g", null, [
                        o("path", {
                          "fill-rule": "evenodd",
                          "clip-rule": "evenodd",
            ...
            ]) : e.legendItem instanceof t(u) ? b((n(), a("div", be, [
              o("span", null, C(e.legendItem.name ?? (!e.legendItem.layer || e.legendItem?.layer?.name === "" ? e.legendItem.layerId : e.legendItem.layer?.name)), 1)
            ])), [
              [V, { externalTrigger: !0 }]
            ]) : e.legendItem instanceof t($1) ? (n(), a("div", Ie, [
              e.legendItem.infoType === t(J).Title && e.legendItem.content ? (n(), a("h3", Le, C(e.legendItem.content), 1)) : e.legendItem.infoType === t(J).Title ? (n(), a("h3", ke, C(e.legendItem.name), 1)) : e.legendItem.infoType === t(J).Text ? (n(), a("p", Ce, C(e.legendItem.content), 1)) : e.legendItem.infoType === t(J).Image ? (n(), a("img", {
                key: 3,
                src: e.legendItem.content,
                alt: "InfoType image not found :("
              }, null, 8, Me)) : e.legendItem.infoType === t(J).Markdown ? (n(), a("div", {
                key: 4,
                class: "ramp-markdown",
                innerHTML: v(e.legendItem.content)
              }, null, 8, ze)) : (n(), T(H1(`${e.legendItem.uid}-info-section`), { key: 5 }))
            ])) : m("", !0),
            e.legendItem.type === t(f).Error && K.value ? (n(), a("div", Se, [
              b((n(), a("button", {
                type: "button",
                class: "text-gray-500 hover:text-black",
                content: t(c)("legend.layer.controls.reload"),
                onMouseover: l[8] || (l[8] = h(() => {
                }, ["stop"])),
                onClick: h(f1, ["stop"]),
            ...
            e.legendItem.type === t(f).Item && e.legendItem instanceof t(u) && e.legendItem.layerOffscale ? b((n(), a("div", {
              key: 9,
              class: "relative p-4 cursor-default",
              content: t(c)("legend.layer.offscale"),
              onMouseover: l[11] || (l[11] = h(() => {
              }, ["stop"])),
              onClick: l[12] || (l[12] = h(() => {
              }, ["stop"])),
              "focus-icon": ""
            ...
            e.legendItem.type === t(f).Item && e.legendItem instanceof t(u) && !e.legendItem.layer?.mapLayer ? b((n(), a("div", {
              key: 10,
              class: "relative p-4 cursor-default",
              content: t(c)("legend.layer.data.only"),
              onMouseover: l[13] || (l[13] = h(() => {
              }, ["stop"])),
              onClick: l[14] || (l[14] = h(() => {
              }, ["stop"])),
              "focus-icon": ""
            ...
            e.legendItem.type === t(f).Item && e.legendItem instanceof t(u) && e.legendItem.layerOffscale ? (n(), a("div", Pe, [
              b((n(), a("button", {
                type: "button",
                class: "p-4",
                content: t(c)("legend.layer.zoomToVisible"),
                onMouseover: l[15] || (l[15] = h(() => {
                }, ["stop"])),
                onClick: l[16] || (l[16] = h((g) => e.legendItem.layer.zoomToVisibleScale(), ["stop"]))
              }, l[34] || (l[34] = [
                o("svg", {
                  class: "m-auto",
                  xmlns: "http://www.w3.org/2000/svg",
            ...
            ])) : e.legendItem.type === t(f).Item && y(t(D).Visibility) ? (n(), T(c1, {
              key: 12,
              checked: e.legendItem.visibility,
              value: e.legendItem,
              isRadio: e.legendItem.parent && e.legendItem.parent.exclusive,
              legendItem: e.legendItem,
              disabled: e.legendItem instanceof t(u) && !e.legendItem.layerControlAvailable(t(p).Visibility),
              label: S.value ? "Group" : "Layer"
            }, null, 8, ["checked", "value", "isRadio", "legendItem", "disabled", "label"])) : m("", !0)
          ], 42, ce)), [
            [U, "show-truncate"],
            [k, {
              placement: "bottom-start",
          ...
          e.legendItem.type === t(f).Placeholder || e.legendItem instanceof t(u) && e.legendItem.layerRedrawing && e.legendItem.visibility ? (n(), a("div", Ge, l[35] || (l[35] = [
            o("div", { class: "progress-line" }, null, -1)
          ]))) : m("", !0)
        ]),
        e.legendItem instanceof t(u) && e.legendItem.symbologyExpanded ? b((n(), a("div", Ue, [
          P.value.length > 0 ? (n(), a("div", De, [
            e.legendItem instanceof t(u) && e.legendItem.description ? (n(), a("p", Oe, C(e.legendItem.description), 1)) : m("", !0),
            (n(!0), a(d1, null, g1(P.value, (g) => (n(), a("div", {
              class: "m-5",
              key: g.uid
            }, [
              g.imgUrl && e.legendItem.symbologyRenderStyle === "images" || !g.imgUrl && n1.value === "ogc-wms" ? (n(), a("div", Fe, [
                g.imgUrl ? (n(), a("div", je, [
                  o("img", {
                    class: "max-w-full",
                    src: g.imgUrl
                ...
                g.label ? b((n(), a("div", Ke, [
                  o("span", null, C(g.label), 1),
                  !g.imgUrl && P.value.length > 1 || g.imgUrl && g.definitionClause ? (n(), T(c1, {
                    key: 0,
                    class: "float-right",
                    value: g,
                    legendItem: e.legendItem,
                    checked: g.visibility,
                    disabled: !y(t(p).Visibility),
                    label: "Symbol"
                  }, null, 8, ["value", "legendItem", "checked", "disabled"])) : m("", !0)
                ])), [
                  [V]
                ]) : m("", !0)
              ])) : (n(), a("div", Qe, [
                ...
                a1.value && e.legendItem.layer.supportsFeatures && (!g.imgUrl && P.value.length > 1 || g.imgUrl && g.definitionClause) ? (n(), T(c1, {
                  key: 2,
                  value: g,
                  legendItem: e.legendItem,
                  checked: g.visibility,
          ...
          Y.value ? m("", !0) : (n(), a("div", e2, [
            b((n(), a("div", t2, [
              o1.value ? (n(), a("div", l2)) : m("", !0),
              b((n(), a("div", n2, [
                o("span", null, C(t(c)("legend.symbology.loading")), 1)
              ])), [
                [V]
              ])
            ])), [
        ...
        e.legendItem.expanded ? (n(), a("div", a2, [
          (n(!0), a(d1, null, g1(e.legendItem.children, (g) => (n(), T(L, {
            legendItem: g,
            key: g.uid,
            onFocusItem: l[20] || (l[20] = (k1) => r.$emit("focusItem", k1))
          }, null, 8, ["legendItem"]))), 128))
        ])) : m("", !0)
      ]));
    };
  }
}), F2 = /* @__PURE__ */ m1(o2, [["__scopeId", "data-v-88992eac"]]);
export {
  F2 as default
};
