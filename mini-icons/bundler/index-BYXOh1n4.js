...
import { _ as C, d as A, F as j, G } from "./main-Dg8Mrowh.js";
...
const D = /* @__PURE__ */ C(q, [["render", U]]), W = /* @__PURE__ */ $({
  ...
  setup(_) {
    const i = k("iApi"), { t } = z(), e = Y(), o = [
      {
        type: "point",
        icon: h(f(() => import("./point-icon-9-nLYalm.js")))
      },
      {
        type: "polyline",
        icon: h(f(() => import("./polyline-icon-CouirBCx.js")))
      },
      {
        type: "polygon",
        icon: h(f(() => import("./polygon-icon-DGdn_Glw.js")))
      },
      {
        type: "circle",
        icon: h(f(() => import("./circle-icon-B6tuHL80.js")))
      },
      {
        type: "rectangle",
        icon: h(f(() => import("./rectangle-icon--oIloXnl.js")))
      }
    ], d = x(() => {
      const a = o.filter((s) => e.supportedTypes.some((c) => c.type === s.type));
      return a.push({
        type: "edit",
        icon: h(f(() => import("./edit-icon-BPOFA1ys.js")))
      }), a;
    }), n = (a) => {
