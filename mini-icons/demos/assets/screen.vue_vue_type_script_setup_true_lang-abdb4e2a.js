...
import { bG as defineComponent, bH as useI18n, bI as inject, bJ as ref, bK as onMounted, bL as onBeforeUnmount, bM as computed, bN as resolveComponent, bO as resolveDirective, bP as openBlock, bQ as createBlock, bR as withCtx, bS as createTextVNode, bT as toDisplayString, bU as unref, bV as createVNode, bW as withDirectives, bX as createElementBlock, bY as Fragment, bZ as renderList, b_ as defineAsyncComponent } from './main-13aeab07.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const legendHeader = defineAsyncComponent(() => __vitePreload(() => import('./header-2bf41c76.js'),true?["./header-2bf41c76.js","./main-13aeab07.js","./preload-helper-a4975f27.js","./main-7434a0ee.css","./header-09bac5de.css"]:void 0,import.meta.url));
    const legendItem = defineAsyncComponent(() => __vitePreload(() => import('./item-d347ce0d.js'),true?["./item-d347ce0d.js","./main-13aeab07.js","./preload-helper-a4975f27.js","./main-7434a0ee.css","./marked.esm-4889c960.js","./item-00193f2e.css"]:void 0,import.meta.url));
    const { t } = useI18n();
