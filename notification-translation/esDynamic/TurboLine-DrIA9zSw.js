import { af as le, hX as ue } from "./main-BLBMGEjI.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-CZKF1naZ.js").then((i) => i.l) : await import("./libtess-BNe8_CN3.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-DrIA9zSw.js.map
