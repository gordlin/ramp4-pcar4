import { iO as A, iP as y, bx as M, fB as $, ha as O, fK as D, hb as B } from "./main-BLBMGEjI.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-VbFgeihs.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-h7EqTHoc.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-9_kNpoTr.js")).default, n = (await import("./index-BF4kD8ju.js")).default, a = (await import("./index-Djx8C0jf.js")).default, w = (await import("./index-xttWBpW-.js")).default, p = (await import("./index-CZh3VCHo.js")).default, r = (await import("./index-IJsplVlI.js")).default, b = (await import("./index-SsfjhmJS.js")).default;
...
//# sourceMappingURL=index-BjE8lGrh.js.map
