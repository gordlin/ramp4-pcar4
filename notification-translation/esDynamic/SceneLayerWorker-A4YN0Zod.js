import { hX as K, bh as D } from "./main-BLBMGEjI.js";
import { y as X } from "./DoubleArray-BXvcQ32l.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-Bv7cahFI.js";
import { n as Z, s as ee } from "./vec3-hpvilMr4.js";
import "./sphere-DIVcvxFo.js";
import "./I3SUtil-BO4JdibT.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-mBx7xEWt.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-BLBMGEjI.js").then((d) => d.qK), import("./main-BLBMGEjI.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-dimNpdPX.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-A4YN0Zod.js.map
