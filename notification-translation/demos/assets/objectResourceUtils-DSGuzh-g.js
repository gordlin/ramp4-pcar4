...
import { m as m$a, a as u$b, e as e$n, c as a$h } from './Texture-CDiylge2.js';
import { H as H$4 } from './InterleavedLayout-DdzRM0vH.js';
...
import { w as w$1, Z as Z$2 } from './sphere-3DP19ri7.js';
import { a as a$f } from './BindType-KnpK3yZX.js';
import { n as n$c } from './symbolColorUtils-eFBb4bAG.js';
...
import './lineSegment-DJSpv1M1.js';
...
function t$i(){if(null==s$b){const t=t=>n$9(`esri/libs/basisu/${t}`);s$b=__vitePreload(() => import('./basis_transcoder-DPajKu0Z.js'),true?__vite__mapDeps([0,1,2,3]):void 0,import.meta.url).then((e=>e.b)).then((({default:e})=>e({locateFile:t}).then((e=>(e.initializeBasis(),delete e.then,e)))));}return s$b}let s$b;
