...
import { _ as C, d as A, F as j, G } from "./main-DvV6XcA1.js";
...
const D = /* @__PURE__ */ C(q, [["render", U]]), W = /* @__PURE__ */ $({
  ...
  setup(_) {
    const i = k("iApi"), { t } = z(), e = Y(), o = [
      {
        type: "point",
        icon: h(f(() => import("./point-icon-jKRPappY.js")))
      },
      {
        type: "polyline",
        icon: h(f(() => import("./polyline-icon-DgkDBbiM.js")))
      },
      {
        type: "polygon",
        icon: h(f(() => import("./polygon-icon-CeBOxd5v.js")))
      },
      {
        type: "circle",
        icon: h(f(() => import("./circle-icon-BGsc5opg.js")))
      },
      {
        type: "rectangle",
        icon: h(f(() => import("./rectangle-icon-jr1SIh11.js")))
      }
    ], d = x(() => {
      const a = o.filter((s) => e.supportedTypes.some((c) => c.type === s.type));
      return a.push({
        type: "edit",
        icon: h(f(() => import("./edit-icon-Cl32Fc8p.js")))
      }), a;
    }), n = (a) => {
