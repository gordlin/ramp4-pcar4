import { af as le, hX as ue } from "./main-CsRmwFtX.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-B2_4nlu6.js").then((i) => i.l) : await import("./libtess-DospBuvo.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-TSjKgcLt.js.map
