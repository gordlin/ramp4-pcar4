import { hX as T } from "./main-CsRmwFtX.js";
...
function y() {
  return new Promise((t) => import("./lyr3DWorker-CVLGMTw3.js").then((r) => r.l).then(({ default: r }) => {
...
//# sourceMappingURL=Lyr3DWorker-T2qPMgBW.js.map
