import { am as m, au as d, a2 as u, K as w, s as p } from "./main-CsRmwFtX.js";
let r = null, s = !0;
function T(e, a, t) {
...
async function B(e, a) {
  ...
  if (n === "image/gif") {
    const { isAnimatedGIF: o, parseGif: c } = await import("./gif-Cwh6Tlg2.js");
    if (o(t)) return c(t, a);
  }
  if (i) {
    const { isAnimatedPNG: o, parseApng: c } = await import("./apng-BXY-PgHd.js");
    if (o(t)) return c(t, a);
  }
...
//# sourceMappingURL=imageUtils-Br9E-rRC.js.map
