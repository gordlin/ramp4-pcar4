import { hX as K, bh as D } from "./main-CsRmwFtX.js";
import { y as X } from "./DoubleArray-D3evP_2i.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-CjG8nLjT.js";
import { n as Z, s as ee } from "./vec3-CTmdpY4x.js";
import "./sphere-Co8H_Q-5.js";
import "./I3SUtil-6sQ814gY.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-DI35kO3k.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-CsRmwFtX.js").then((d) => d.qK), import("./main-CsRmwFtX.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-6Qp7XSbs.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-GiigZe6g.js.map
