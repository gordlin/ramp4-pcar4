import { iO as A, iP as y, bx as M, fB as $, ha as O, fK as D, hb as B } from "./main-BJVJryus.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-Dqxfki-E.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-BNvGNmK8.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-BeogFwax.js")).default, n = (await import("./index-BsmRYUjM.js")).default, a = (await import("./index-DFqs9ogY.js")).default, w = (await import("./index-x6ygroTI.js")).default, p = (await import("./index-CwqtTzY8.js")).default, r = (await import("./index-CtIhDA_R.js")).default, b = (await import("./index-BgN5pRb2.js")).default;
...
//# sourceMappingURL=index-C0xDpuhn.js.map
