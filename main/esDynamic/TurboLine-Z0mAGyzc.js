import { af as le, hX as ue } from "./main-BJVJryus.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-DkYMpo-T.js").then((i) => i.l) : await import("./libtess-CTt9dpOh.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-Z0mAGyzc.js.map
