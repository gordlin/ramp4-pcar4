import { hX as K, bh as D } from "./main-D-HsupCS.js";
import { y as X } from "./DoubleArray-D-Mn2wdN.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-BMUzsn8b.js";
import { n as Z, s as ee } from "./vec3-DttqXUlY.js";
import "./sphere-DVCHXMcc.js";
import "./I3SUtil-Bn7vy-oO.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-8PYB05Sz.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-D-HsupCS.js").then((d) => d.qK), import("./main-D-HsupCS.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-CTnkMMtu.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-CcMbqOtQ.js.map
