import { hX as K, bh as D } from "./main-BJVJryus.js";
import { y as X } from "./DoubleArray-CrAB9oJb.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-CUh2iwop.js";
import { n as Z, s as ee } from "./vec3-Zr1dq3cw.js";
import "./sphere-D5fgzXSf.js";
import "./I3SUtil-DIpDrHzj.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-DS_FYOtA.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-BJVJryus.js").then((d) => d.qK), import("./main-BJVJryus.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-D-whi1Nh.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-Brq6Sfzc.js.map
