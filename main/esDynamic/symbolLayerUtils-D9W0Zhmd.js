import { dK as d, s as n, dL as a, bl as m, dM as v, ci as c } from "./main-D-HsupCS.js";
let u = h();
function h() {
  return new d(50);
}
async function p(r, o = null) {
  if (!r.isPrimitive) {
    ...
    const { fetch: l } = await import("./objectResourceUtils-CcEN8LmA.js"), f = await l(e, { disableTextures: !0 }), s = a(f.referenceBoundingBox, c());
    return u.put(e, s), s;
  }
...
//# sourceMappingURL=symbolLayerUtils-D9W0Zhmd.js.map
