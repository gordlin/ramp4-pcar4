import { iO as A, iP as y, bx as M, fB as $, ha as O, fK as D, hb as B } from "./main-DhP7SIFv.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-tm4a3Gsg.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-BMQZbrv7.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-DD2YFRFQ.js")).default, n = (await import("./index-BnToghNp.js")).default, a = (await import("./index-Dm_4j3v0.js")).default, w = (await import("./index-x82G_shc.js")).default, p = (await import("./index--bhGvapw.js")).default, r = (await import("./index-Bhpq0Pkp.js")).default, b = (await import("./index-Ztuevndt.js")).default;
...
//# sourceMappingURL=index-Bgq7leca.js.map
