import { hX as K, bh as D } from "./main-DhP7SIFv.js";
import { y as X } from "./DoubleArray-xqxr7CgP.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-COKVGZg3.js";
import { n as Z, s as ee } from "./vec3-REvt1t72.js";
import "./sphere-BwvsItWq.js";
import "./I3SUtil-CVlnv4Ui.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-CRDXcUw5.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-DhP7SIFv.js").then((d) => d.qK), import("./main-DhP7SIFv.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-CiT58CD8.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-YDhz4ztz.js.map
