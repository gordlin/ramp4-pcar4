import { af as le, hX as ue } from "./main-DhP7SIFv.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-DFbV3hJD.js").then((i) => i.l) : await import("./libtess-DEWtRoBJ.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-BYRgAzwG.js.map
