...
import { _ as C, d as A, F as j, G } from "./main-ClbW7sOU.js";
...
const D = /* @__PURE__ */ C(q, [["render", U]]), W = /* @__PURE__ */ $({
  ...
  setup(_) {
    const i = k("iApi"), { t } = z(), e = Y(), o = [
      {
        type: "point",
        icon: h(f(() => import("./point-icon-4gJfKY36.js")))
      },
      {
        type: "polyline",
        icon: h(f(() => import("./polyline-icon-DB5zbJxS.js")))
      },
      {
        type: "polygon",
        icon: h(f(() => import("./polygon-icon-CVC5CfFe.js")))
      },
      {
        type: "circle",
        icon: h(f(() => import("./circle-icon-DsUoZZud.js")))
      },
      {
        type: "rectangle",
        icon: h(f(() => import("./rectangle-icon-CBAk2ejX.js")))
      }
    ], d = x(() => {
      const a = o.filter((s) => e.supportedTypes.some((c) => c.type === s.type));
      return a.push({
        type: "edit",
        icon: h(f(() => import("./edit-icon-Be7qa9qa.js")))
      }), a;
    }), n = (a) => {
