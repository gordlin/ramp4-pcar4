import { iO as A, iP as y, bx as M, fB as $, ha as O, fK as D, hb as B } from "./main-bLgM20QT.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-B3dvS0Z2.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-Ck8jSSo-.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-CvFURFGi.js")).default, n = (await import("./index-C1iKDY21.js")).default, a = (await import("./index-Cqrl-nE3.js")).default, w = (await import("./index-CW14SB62.js")).default, p = (await import("./index-BMDqgkCJ.js")).default, r = (await import("./index-CSGK5osR.js")).default, b = (await import("./index-BkLbebMY.js")).default;
...
//# sourceMappingURL=index-D65-W_0c.js.map
