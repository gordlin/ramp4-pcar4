import { af as le, hX as ue } from "./main-Luy4f6Kc.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-CVUZdVvt.js").then((i) => i.l) : await import("./libtess-Dyo6Kny3.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-DJ_DQpB7.js.map
