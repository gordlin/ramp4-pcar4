import { hX as K, bh as D } from "./main-bLgM20QT.js";
import { y as X } from "./DoubleArray-Csa214yo.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-BpfgUWzt.js";
import { n as Z, s as ee } from "./vec3-Cuk0PzcX.js";
import "./sphere-QLwrVRbU.js";
import "./I3SUtil-1XG-jxff.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-BPf5vyDu.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-bLgM20QT.js").then((d) => d.qK), import("./main-bLgM20QT.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-CWix_v6O.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-RVoy_L01.js.map
