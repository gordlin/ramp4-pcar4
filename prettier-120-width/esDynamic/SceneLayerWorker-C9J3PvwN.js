import { hX as K, bh as D } from "./main-Luy4f6Kc.js";
import { y as X } from "./DoubleArray-CwBKAacy.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-CbVkQFoZ.js";
import { n as Z, s as ee } from "./vec3-BOyUxlEv.js";
import "./sphere-7On_mkdj.js";
import "./I3SUtil-CBL2oXm-.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-C6qt-1yS.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-Luy4f6Kc.js").then((d) => d.qK), import("./main-Luy4f6Kc.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-CVvtOge9.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-C9J3PvwN.js.map
