import { y as ir, eM as Ye, a6 as J, dH as Na, ic as at, aU as we, aR as ie, aS as te, aT as Ie, eJ as $, aP as ar, eK as le, nA as fi, fl as di, bh as vt, a4 as _a, cW as Ra, d0 as La, df as hi, oo as vr, ba as St, i9 as pi, Q as sr, op as Pa, a2 as Oa, af as mi, ag as Ua } from "./main-bLgM20QT.js";
import { m as U, a as ge, n as De, h as Nt, c as Be, r as Yt, b as se } from "./TimeOnly-DSFJxLFs.js";
import { t as ce } from "./ImmutableArray-Bwhwqhbl.js";
import { s as za, p as gi } from "./number-BUZRvW2M.js";
let qt = class {
  constructor(t) {
    this.source = t;
  }
...
async function _o() {
  return lt([await import("./geomasync-Dejw7lLF.js")], "async"), !0;
}
class Pt extends qt {
  constructor(t) {
...
async function Ca() {
  const e = await import("./geometryEngine-VfflEYdZ.js");
  return wa = !0, Ms(e), !0;
}
let Ln = null;
function Ar() {
...
async function Aa() {
  await _o(), Ne = await import("./arcadeAsyncRuntime-Dja8TXgu.js");
...
async function Sa() {
  await Ar();
  const [e, t, n, r, a, o] = await Promise.all([import("./featureSetUtils-COXLRpjR.js").then((s) => s.l), import("./featuresetbase-CBJewhFl.js"), import("./featuresetgeom-DqwSGSne.js"), import("./featuresetstats-DULCQK8m.js"), import("./featuresetstring-C0HDwEJm.js"), import("./knowledgegraph--03MpEAW.js")]);
...
//# sourceMappingURL=arcadeUtils-Hgz-dtKn.js.map
