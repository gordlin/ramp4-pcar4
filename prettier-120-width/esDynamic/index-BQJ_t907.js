import { iO as A, iP as y, bx as M, fB as $, ha as O, fK as D, hb as B } from "./main-Luy4f6Kc.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-DrPM2-bl.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-DVEud5LO.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-Ram5Z1WV.js")).default, n = (await import("./index-DeK3SE-L.js")).default, a = (await import("./index-R0ZBrpLd.js")).default, w = (await import("./index-1Tiigtmg.js")).default, p = (await import("./index-G-6z_ZY-.js")).default, r = (await import("./index-D62m-Bjn.js")).default, b = (await import("./index-6kTpea6R.js")).default;
...
//# sourceMappingURL=index-BQJ_t907.js.map
