import { af as le, hX as ue } from "./main-bLgM20QT.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-1WmhZAqb.js").then((i) => i.l) : await import("./libtess-CUdAcRlW.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-BJ5xQIIg.js.map
