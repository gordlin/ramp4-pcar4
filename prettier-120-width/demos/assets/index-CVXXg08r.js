import { bF as defineComponent, bG as useI18n, bH as inject, bL as computed, bM as resolveComponent, bQ as openBlock, bO as createBlock, bP as withCtx, fG as createBaseVNode, fH as normalizeClass, bT as unref, fM as createCommentVNode, i8 as _export_sfc, bW as createElementBlock, mv as detectOverflow, bI as ref, bJ as onMounted, bK as onBeforeUnmount, bN as resolveDirective, bV as withDirectives, i7 as vShow, ir as renderSlot, mw as createPopper, mx as useNotificationStore, bS as toDisplayString, fE as usePanelStore, hf as useAppbarStore, fK as onBeforeMount, my as onUpdated, mz as nextTick, bX as Fragment, bY as renderList, bU as createVNode, mA as getCurrentInstance, kL as resolveDynamicComponent, mB as AboutRampDropdown, bA as FixtureInstance, fO as GlobalEvents } from './main-C6zPP_lC.js';
...
const MoreButton = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-15704493"]]);
    ...
    onUpdated(() => {
      nextTick(() => {
        ...
        Object.keys(overflowFlags.value).forEach((key2) => {
          if (!element.querySelector(`.identifier-${key2}`)) delete overflowFlags.value[key2];
        });
      });
    });
    return (_ctx, _cache) => {
