const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./header-wu-vylIw.js","./main-C6zPP_lC.js","./preload-helper-dJJaZANz.js","./main-D4DecFi_.css","./header-DCuaZtjJ.css","./item-DPVsdFZy.js","./marked.esm-DcwJ8j7Z.js","./item-CNS_mBS6.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './preload-helper-dJJaZANz.js';
import { bF as defineComponent, bG as useI18n, bH as inject, bI as ref, bJ as onMounted, bK as onBeforeUnmount, bL as computed, bM as resolveComponent, bN as resolveDirective, bO as createBlock, bP as withCtx, bQ as openBlock, bR as createTextVNode, bS as toDisplayString, bT as unref, bU as createVNode, bV as withDirectives, bW as createElementBlock, bX as Fragment, bY as renderList, bZ as defineAsyncComponent } from './main-C6zPP_lC.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const legendHeader = defineAsyncComponent(() => __vitePreload(() => import('./header-wu-vylIw.js'),true?__vite__mapDeps([0,1,2,3,4]):void 0,import.meta.url));
    const legendItem = defineAsyncComponent(() => __vitePreload(() => import('./item-DPVsdFZy.js'),true?__vite__mapDeps([5,1,2,3,6,7]):void 0,import.meta.url));
    const { t } = useI18n();
