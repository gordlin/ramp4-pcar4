import { iS as commonjsGlobal, iT as getDefaultExportFromCjs, bA as FixtureInstance, fF as useExportStore, he as markRaw, hf as useAppbarStore } from './main-C6zPP_lC.js';
import { f as fabric } from './fabric-DLacs3cE.js';
import { _ as _sfc_main } from './screen.vue_vue_type_script_setup_true_lang-CMCmCkkw.js';
...
class ExportAPI extends FixtureInstance {
  ...
  async make(canvas, panelWidth) {
    ...
    if (this.customRendererFunc) {
      ...
      const fbGroup = new fabric.fabric.Group(Object.values(selectedFabricObjects), {
