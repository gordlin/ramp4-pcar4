import { af as le, hX as ue } from "./main-BcMvGAQ2.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-CSio3CkG.js").then((i) => i.l) : await import("./libtess-DoWZLbSd.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-Dbhjklxf.js.map
