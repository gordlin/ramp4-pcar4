import { iO as A, iP as y, bx as M, fB as $, ha as O, fK as D, hb as B } from "./main-BcMvGAQ2.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-DIGCDQkQ.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-BItVCILt.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-BsjQmHgy.js")).default, n = (await import("./index-HSaXy8_f.js")).default, a = (await import("./index-C9SYkXr-.js")).default, w = (await import("./index-DdBJUX36.js")).default, p = (await import("./index-DjNVZ_oS.js")).default, r = (await import("./index-DkPT2dWi.js")).default, b = (await import("./index-7-Odn5VN.js")).default;
...
//# sourceMappingURL=index-BHtvb6_e.js.map
