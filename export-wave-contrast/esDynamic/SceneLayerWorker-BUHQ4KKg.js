import { hX as K, bh as D } from "./main-BcMvGAQ2.js";
import { y as X } from "./DoubleArray-C4GCFvFZ.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-CEZAZBIJ.js";
import { n as Z, s as ee } from "./vec3-COsOO6C4.js";
import "./sphere-D4gD2PSo.js";
import "./I3SUtil-57mn8sl9.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-BWkAyIGA.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-BcMvGAQ2.js").then((d) => d.qK), import("./main-BcMvGAQ2.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-B66ODsBG.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-BUHQ4KKg.js.map
