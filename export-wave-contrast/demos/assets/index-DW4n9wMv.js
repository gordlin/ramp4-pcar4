const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./screen-BLTgWyZN.js","./main-CLKD9wBG.js","./preload-helper-dJJaZANz.js","./main-B99Uwap2.css","./table-state-manager-BxhJ2X4c.js","./screen-Db-04tQB.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './preload-helper-dJJaZANz.js';
import { bA as FixtureInstance, hh as useGridStore, he as markRaw, hf as useAppbarStore } from './main-CLKD9wBG.js';
    ...
    this.$iApi.panel.register(
      {
        grid: {
          screens: {
            "grid-screen": () => markRaw(__vitePreload(() => import('./screen-BLTgWyZN.js'),true?__vite__mapDeps([0,1,2,3,4,5]):void 0,import.meta.url))
          },
          style: {
            width: "450px"
          },
