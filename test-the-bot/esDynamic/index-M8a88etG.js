import { iO as A, iP as y, bx as M, fB as $, ha as O, fK as D, hb as B } from "./main-DiJ066-V.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-G-GvhRHx.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-ClO3jz3d.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-C2gex4J4.js")).default, n = (await import("./index-BgEz6TVT.js")).default, a = (await import("./index-CyjJdfB4.js")).default, w = (await import("./index-CtOpaPU9.js")).default, p = (await import("./index-LUFNRj7_.js")).default, r = (await import("./index-DrO-Gptt.js")).default, b = (await import("./index-BIbZnZDU.js")).default;
...
//# sourceMappingURL=index-M8a88etG.js.map
