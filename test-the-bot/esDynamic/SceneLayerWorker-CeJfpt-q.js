import { hX as K, bh as D } from "./main-DiJ066-V.js";
import { y as X } from "./DoubleArray-DkG5sFAG.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-Dfqv297d.js";
import { n as Z, s as ee } from "./vec3-Do5uMmmK.js";
import "./sphere-CCDxHdYP.js";
import "./I3SUtil-8uZP7sHt.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-rY9ZKPwn.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-DiJ066-V.js").then((d) => d.qK), import("./main-DiJ066-V.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-rH_SEc-L.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-CeJfpt-q.js.map
