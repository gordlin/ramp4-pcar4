import { af as le, hX as ue } from "./main-DiJ066-V.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-DdST6-3N.js").then((i) => i.l) : await import("./libtess-DfOKFOun.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-B8g013pA.js.map
