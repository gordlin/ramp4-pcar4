import { hX as K, bh as D } from "./main-DKtm-tq8.js";
import { y as X } from "./DoubleArray-DReSKO_i.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-Duqth2rE.js";
import { n as Z, s as ee } from "./vec3-BaYhs_7O.js";
import "./sphere-DjYQGjYV.js";
import "./I3SUtil-H27sFrxY.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-4RWU7Ju-.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-DKtm-tq8.js").then((d) => d.qK), import("./main-DKtm-tq8.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-DXQPB0si.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-CqGSN65t.js.map
