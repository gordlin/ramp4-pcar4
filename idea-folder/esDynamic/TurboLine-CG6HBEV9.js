import { af as le, hX as ue } from "./main-DKtm-tq8.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-C54gG7Xj.js").then((i) => i.l) : await import("./libtess-cdfqonzf.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-CG6HBEV9.js.map
