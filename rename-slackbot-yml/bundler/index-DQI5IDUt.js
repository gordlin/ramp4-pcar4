...
import { _ as C, d as A, F as j, G } from "./main-DuhNULaD.js";
...
const D = /* @__PURE__ */ C(q, [["render", U]]), W = /* @__PURE__ */ $({
  ...
  setup(_) {
    const i = k("iApi"), { t } = z(), e = Y(), o = [
      {
        type: "point",
        icon: h(f(() => import("./point-icon-DBb93LdA.js")))
      },
      {
        type: "polyline",
        icon: h(f(() => import("./polyline-icon-CZ17pu1A.js")))
      },
      {
        type: "polygon",
        icon: h(f(() => import("./polygon-icon-BOi1OHrY.js")))
      },
      {
        type: "circle",
        icon: h(f(() => import("./circle-icon-gY_9onl5.js")))
      },
      {
        type: "rectangle",
        icon: h(f(() => import("./rectangle-icon-WH77S2Nc.js")))
      }
    ], d = x(() => {
      const a = o.filter((s) => e.supportedTypes.some((c) => c.type === s.type));
      return a.push({
        type: "edit",
        icon: h(f(() => import("./edit-icon-CHpUqaRP.js")))
      }), a;
    }), n = (a) => {
