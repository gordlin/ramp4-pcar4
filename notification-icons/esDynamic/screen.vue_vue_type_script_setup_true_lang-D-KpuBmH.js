import { bC as E, bD as L, bE as x, bF as C, bG as I, bH as A, bI as B, bJ as D, bK as i, bL as l, bM as p, bN as n, bO as w, bP as N, bQ as s, bR as T, bS as V, bT as u, bU as j, bV as F, bW as d } from "./main-XkaEVVIS.js";
const H = ["content"], O = /* @__PURE__ */ E({
  ...
  setup(b) {
    const v = d(() => import("./header-DvuTeonw.js")), m = d(() => import("./item-l0By95KE.js")), { t: r } = L(), _ = x("iApi"), e = C(), a = () => {
      e.value._tippy.hide();
    }, o = (t) => {
...
//# sourceMappingURL=screen.vue_vue_type_script_setup_true_lang-D-KpuBmH.js.map
