import { af as le, hX as ue } from "./main-XkaEVVIS.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-Blsz1WhC.js").then((i) => i.l) : await import("./libtess-BSU0fOFS.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-oGXEHstt.js.map
