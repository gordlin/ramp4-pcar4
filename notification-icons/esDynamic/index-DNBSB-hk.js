import { iO as A, iP as y, bx as M, fB as $, ha as O, fK as D, hb as B } from "./main-XkaEVVIS.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-BABhbL9N.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-c9xYaeOB.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-CVCYPBHt.js")).default, n = (await import("./index-DqECBL-O.js")).default, a = (await import("./index-DF2HdM9_.js")).default, w = (await import("./index-CKB00USq.js")).default, p = (await import("./index-CXRKp8Te.js")).default, r = (await import("./index-DW9rkSp8.js")).default, b = (await import("./index-BbXLDO9n.js")).default;
...
//# sourceMappingURL=index-DNBSB-hk.js.map
