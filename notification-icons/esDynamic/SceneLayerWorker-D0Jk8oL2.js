import { hX as K, bh as D } from "./main-XkaEVVIS.js";
import { y as X } from "./DoubleArray-B40iB6Nl.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-Bs3zdcn6.js";
import { n as Z, s as ee } from "./vec3-Db01RjhM.js";
import "./sphere-jIefucCF.js";
import "./I3SUtil-ZF1JLPFd.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-Drh5qUWi.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-XkaEVVIS.js").then((d) => d.qK), import("./main-XkaEVVIS.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-Dqvpqyes.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-D0Jk8oL2.js.map
