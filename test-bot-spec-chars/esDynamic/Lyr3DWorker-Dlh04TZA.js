import { hX as T } from "./main-B3NqHQap.js";
...
function y() {
  return new Promise((t) => import("./lyr3DWorker-BITiyQ15.js").then((r) => r.l).then(({ default: r }) => {
...
//# sourceMappingURL=Lyr3DWorker-Dlh04TZA.js.map
