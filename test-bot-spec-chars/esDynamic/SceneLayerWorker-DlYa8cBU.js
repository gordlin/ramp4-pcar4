import { hX as K, bh as D } from "./main-B3NqHQap.js";
import { y as X } from "./DoubleArray-eUCgIMLs.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-BpAtuQfr.js";
import { n as Z, s as ee } from "./vec3-B-eStvYY.js";
import "./sphere-CjjevSHT.js";
import "./I3SUtil-BGr6OmEg.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-s-hbBr-D.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-B3NqHQap.js").then((d) => d.qK), import("./main-B3NqHQap.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-Cb9Jgq6K.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-DlYa8cBU.js.map
