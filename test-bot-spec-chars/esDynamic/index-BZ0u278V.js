import { iO as A, iP as y, bx as M, fB as $, ha as O, fK as D, hb as B } from "./main-B3NqHQap.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-CAD2O7Vi.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-CjvtcGQb.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-BTmAdC7k.js")).default, n = (await import("./index-xVu111DL.js")).default, a = (await import("./index-D6kF6yKI.js")).default, w = (await import("./index-IFmSKovs.js")).default, p = (await import("./index-DgSnZTXP.js")).default, r = (await import("./index-CbKSjGcW.js")).default, b = (await import("./index-B2__bVes.js")).default;
...
//# sourceMappingURL=index-BZ0u278V.js.map
