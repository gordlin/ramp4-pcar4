import { af as le, hX as ue } from "./main-B3NqHQap.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-8cdLahV-.js").then((i) => i.l) : await import("./libtess-CrkVFEem.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-Cn5Fl7Zc.js.map
