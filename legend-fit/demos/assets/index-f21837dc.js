...
import { bG as defineComponent, bI as inject, bK as resolveComponent, bM as openBlock, bN as createBlock, bO as withCtx, fE as createBaseVNode, iM as normalizeStyle, bP as createTextVNode, bH as useI18n, bQ as toDisplayString, bR as unref, bB as FixtureInstance, he as markRaw } from './main-b051658a.js';
        ...
        config: {
          screens: {
            ...
            "p-2-screen-1": () => {
              return new Promise(
                (resolve) => setTimeout(
                  () => __vitePreload(() => import('./p2-screen-1-1f309607.js'),true?["./p2-screen-1-1f309607.js","./main-b051658a.js","./preload-helper-a4975f27.js","./main-b7c3e3c8.css"]:void 0,import.meta.url).then(
                    (data) => {
                      resolve(data);
                    }
                  ),
