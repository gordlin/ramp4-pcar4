...
import { _ as C, d as A, F as j, G } from "./main-Dv58_8fZ.js";
...
const D = /* @__PURE__ */ C(q, [["render", U]]), W = /* @__PURE__ */ $({
  ...
  setup(_) {
    const i = k("iApi"), { t } = z(), e = Y(), o = [
      {
        type: "point",
        icon: h(f(() => import("./point-icon-Cum-3Q7b.js")))
      },
      {
        type: "polyline",
        icon: h(f(() => import("./polyline-icon-DiyXugfJ.js")))
      },
      {
        type: "polygon",
        icon: h(f(() => import("./polygon-icon-TpeSVfs-.js")))
      },
      {
        type: "circle",
        icon: h(f(() => import("./circle-icon-4qM0SLIN.js")))
      },
      {
        type: "rectangle",
        icon: h(f(() => import("./rectangle-icon-D7mnyt-K.js")))
      }
    ], d = x(() => {
      const a = o.filter((s) => e.supportedTypes.some((c) => c.type === s.type));
      return a.push({
        type: "edit",
        icon: h(f(() => import("./edit-icon-Cmk9qHAD.js")))
      }), a;
    }), n = (a) => {
